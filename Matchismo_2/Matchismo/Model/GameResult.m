...
- (id)initFromPropertyList:(id)plist
{
    ...
    if (self) {
        if ([plist isKindOfClass:[NSDictionary class]]) {
            ...
            _gameName = resultDictionary[GAME_KIND_KEY];
...
- (id)asPropertyList
{
    return @{ START_KEY : self.start, END_KEY : self.end, SCORE_KEY : @(self.score), GAME_KIND_KEY : self.gameName };
}
...
- (id)initWithGameKind:(NSString*) name
{
    self = [super init];
    if (self) {
        _start = [NSDate date];
