...
- (void)flipCardAtIndex:(NSUInteger)index
{
    ...
    if(self.threeCardMatchingMode)
    {   //accumulative, should be specified more explicitly
        NSMutableArray* allFacingUpCards = [[self getAllCardsFacingUp] mutableCopy];
        [allFacingUpCards addObject:(id)card];
        self.gameHistory[@"card_objects"]   = allFacingUpCards;
    }
    else
